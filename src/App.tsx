...
const projects = [
      ...
      },
      {
            title: "Blog sites",
            description:
                  "Managing 40-50 blog site built with WordPress. Features include a custom theme, plugin integration, and responsive design.",
      ...
      },
      {
            ...
            description:
                  "A responsive AI content generator that creates articles and blog posts using natural language processing.",
            technologies: ["React", "Node.js", "OpenAI API"],
            image: herb0tImage1,
      },
      {
            title: "Construction App (In Progress)",
            description:
                  "A construction management application built with React, Node.js, and MongoDB. Features include resource pricing, quote generation, and project tracking.",
            technologies: ["React", "Node.js", "MongoDB", "Express", "n8n"],
            image: herb0tImage1, // You can add specific project images later
      },
      {
            title: "Responsive Website Design",
            description:
                  "Responsive website designs created using PhotoShop and implemented with SCSS/SASS and CSS.",
            technologies: ["PhotoShop", "SCSS/SASS", "CSS"],
            image: herb0tImage2,
      },
      {
            title: "Unity Game Development",
            description:
                  "A Unity puzzle game that challenges players focus on how every disc interacts with each other to solve puzzles.",
            technologies: ["Unity", "C#", "Asprite", "Photoshop"],
            image: herb0tImage1,
      },
      {
...
function App() {
      ...
      // trigger the change every 15 seconds
      useEffect(() => {
                                          ...
                                          return (
                                                <Box
                                                      ...
                                                      sx={{
                                                            ...
                                                            "&:hover": {
                                                                  transform:
                                                                        "rotate(${angle}deg) scale(1.2)",
                                                                  boxShadow:
                                                                        "0 4px 16px rgba(237, 28, 36, 0.4)",
                                                            },
                                                      }}
                                                      onClick={() =>
                                                            setSelectedProject(
